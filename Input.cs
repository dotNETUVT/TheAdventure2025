...
public unsafe class Input
{
    ...
    private bool _wasWPressedLastFrame = false;
    private bool _wasSPressedLastFrame = false;
    ...
    public bool IsKeyEPressed()
    {
        ...
        bool isPressed = keyboardState[(int)KeyCode.E] == 1;
        bool result = isPressed && !_wasEPressedLastFrame;
        _wasEPressedLastFrame = isPressed;
        return result;
    }
    ...
    {
        ReadOnlySpan<byte> keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
        bool isPressed = keyboardState[(int)KeyCode.W] == 1;
        bool result = isPressed && !_wasWPressedLastFrame;
        _wasWPressedLastFrame = isPressed;
        return result;
    }
    ...
    {
        ReadOnlySpan<byte> keyboardState = new(_sdl.GetKeyboardState(null), (int)KeyCode.Count);
        bool isPressed = keyboardState[(int)KeyCode.S] == 1;
        bool result = isPressed && !_wasSPressedLastFrame;
        _wasSPressedLastFrame = isPressed;
        return result;
    }
